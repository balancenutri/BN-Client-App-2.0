...
export const messageByKhyati = async (req, res) => {
  try {
    const response_data = {
      ...
      info_text:
        "<font face='Roboto-Regular' size='5'>Welcome once again to Balance Nutrition!<br>Glad to know you have decided to continue your journey & now it’s time to learn a few new concepts, unlearn a few old ones & get ready for <b>Advanced</b> learning.</font>",
      info_text2: "",
